...
unrealRootPath=/home/christophe/GameEngines/UnrealEngine/UE4_26_2
CodeNameProtectRootPath=/home/christophe/Documents/Work/CodeNameProtect/Code-Name-Protect/CodeNameProtect

gameProjectFile=/home/christophe/Documents/Work/CodeNameProtect/Code-Name-Protect/CodeNameProtect/CodeNameProtect.uproject
...
include(CodeNameProtectSource.pri)
include(CodeNameProtectHeader.pri)
include(CodeNameProtectConfig.pri)
include(CodeNameProtectIncludes.pri)
include(CodeNameProtectDefines.pri)

CodeNameProtect-Linux-Debug.commands = $$build CodeNameProtect Linux Debug  -project="\"$$gameProjectFile\"" $$args
CodeNameProtect-Linux-DebugGame.commands = $$build CodeNameProtect Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CodeNameProtect-Linux-Shipping.commands = $$build CodeNameProtect Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CodeNameProtect-Linux-Test.commands = $$build CodeNameProtect Linux Test  -project="\"$$gameProjectFile\"" $$args
CodeNameProtect.commands = $$build CodeNameProtect Linux Development  -project="\"$$gameProjectFile\"" $$args

CodeNameProtectEditor-Linux-Debug.commands = $$build CodeNameProtectEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
CodeNameProtectEditor-Linux-DebugGame.commands = $$build CodeNameProtectEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CodeNameProtectEditor-Linux-Shipping.commands = $$build CodeNameProtectEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CodeNameProtectEditor-Linux-Test.commands = $$build CodeNameProtectEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
CodeNameProtectEditor.commands = $$build CodeNameProtectEditor Linux Development  -project="\"$$gameProjectFile\"" $$args

CodeNameProtectServer-Linux-Debug.commands = $$build CodeNameProtectServer Linux Debug  -project="\"$$gameProjectFile\"" $$args
CodeNameProtectServer-Linux-DebugGame.commands = $$build CodeNameProtectServer Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CodeNameProtectServer-Linux-Shipping.commands = $$build CodeNameProtectServer Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CodeNameProtectServer-Linux-Test.commands = $$build CodeNameProtectServer Linux Test  -project="\"$$gameProjectFile\"" $$args
CodeNameProtectServer.commands = $$build CodeNameProtectServer Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	CodeNameProtect-Linux-Debug \
	CodeNameProtect-Linux-DebugGame \
	CodeNameProtect-Linux-Shipping \
	CodeNameProtect-Linux-Test \
	CodeNameProtect \
	CodeNameProtectEditor-Linux-Debug \
	CodeNameProtectEditor-Linux-DebugGame \
	CodeNameProtectEditor-Linux-Shipping \
	CodeNameProtectEditor-Linux-Test \
	CodeNameProtectEditor \
	CodeNameProtectServer-Linux-Debug \
	CodeNameProtectServer-Linux-DebugGame \
	CodeNameProtectServer-Linux-Shipping \
	CodeNameProtectServer-Linux-Test \
	CodeNameProtectServer \
